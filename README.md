# GS1 Portfolio – Olov Bohlin Tsigrimanis

Prototypdemos byggda inför ansökan till tjänsten Training Manager på GS1 Sweden.

## Demos

- **[Onboarding-modul](gs1_onboarding_modul.html)** – interaktiv e-learningmodul som introducerar GS1-standarder, GTIN-struktur och registreringsprocessen, med quiz och progressionsspårning
- **[Utbildningsportal](gs1_utbildningsportal.html)** – LMS-gränssnitt med kurskatalog, filtrering och pågående kurser
